...
//    	https://api.xiaoshouyi.com/data/v1/notice/notify/list
    	 try {
//			JSONObject jsonObject=new JSONObject();
			 RkhdHttpClient rkhdHttpClient=RkhdHttpClient.instance();
			 RkhdHttpData rkhdHttpData= RkhdHttpData.newBuilder().build();
...
//			 rkhdHttpData.setBody(jsonObject.toJSONString());
			 rkhdHttpData.setCallString("/data/v1/notice/notify/info");
			 String performRequest = rkhdHttpClient.performRequest(rkhdHttpData);
			 logger.info(performRequest);
		} catch (IOException e) {
