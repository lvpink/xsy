...
private static final Logger logger = LoggerFactory.getLogger();
	...
	public String execute(Request arg0, Long arg1, Long arg2) {
    	...
    	String wsRes = MatnrWSImpl.webservice(cpbm_c,xszz_c,xsfz_c);
    	logger.info("查询套件组合产品信息-->完成||msg->"+JSONObject.parseObject(wsRes).getString("msg"));
